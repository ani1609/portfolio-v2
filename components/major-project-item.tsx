      ...
      {majorProject.id % 2 !== 0 ? (
        ...
        >
          <Link
            ...
            className='group left-0 w-full max-md:pointer-events-none rounded-sm overflow-hidden absolute z-[inherit] bg-[#182b3c] md:bg-[#43ae95] h-full md:w-[60%] shadow-[0_0px_30px_-15px_rgba(2,12,27,0.7)]'
          >
            <Image
        ...
        >
          <Link
            ...
            target='_blank'
            rel='noopener noreferrer'
            className='group right-0 w-full max-md:pointer-events-none rounded-sm overflow-hidden absolute z-[inherit] bg-[#182b3c] md:bg-[#43ae95] h-full md:w-[60%] shadow-[0_0px_30px_-15px_rgba(2,12,27,0.7)]'
          >
            <Image
              src={majorProject.image}
              alt='project_image'
